...
const DeleteConfirmModal = ({deletingDoctor, refetch, setDeletingDoctor}) => {
    ...
    const handleDelete = () =>{
        fetch(`http://localhost:5050/doctor/${email}`, {
            method: 'DELETE',
            headers: {
        ...
        <div>
            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <p class="py-4">You've been selected htmlFor a chance to get one year of subscription to use Wikipedia htmlFor free!</p>
